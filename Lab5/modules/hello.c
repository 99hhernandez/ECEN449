 ...
 *
 * Demonstrate module initialization, module release and printk
 *
 * (Adopted from various example modules including those found in the 
...
/* Here we define what functions we want to use for initialization 
 * and cleanup */
module_init(my_init);
module_exit(my_exit);
