...
# =============== COMMENT OUT FOR btnCounter MODULE ===============
## LEDs
#set_property PACKAGE_PIN M14 [get_ports {LEDS[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {LEDS[0]}]
...
## BUTTONS
#set_property PACKAGE_PIN Y16 [get_ports {BTN[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {BTN[0]}]

#set_property PACKAGE_PIN K19 [get_ports {BTN[1]}]  
...
# =============== COMMENT OUT FOR jackpot MODULE ===============
## SWITCHES
set_property PACKAGE_PIN G15 [get_ports {SWITCHES[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SWITCHES[0]}]
